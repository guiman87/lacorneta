...
<div class="em-events-search em-search <?php if( !empty($args['main_classes']) ) echo implode(' ', $args['main_classes']); ?>">
	<form action="<?php echo !empty($args['search_url']) ? $args['search_url'] : EM_URI; ?>" method="post" class="em-events-search-form em-search-form">
		...
		<input type="text" name="em_search" style="color: #3955AF;" class="em-events-search-text em-search-text" value="BOLICHES, CIUDAD, BARRIO, DEPARTAMENTO" onfocus="if(this.value=='BOLICHES, CIUDAD, BARRIO, DEPARTAMENTO')this.value=''" onblur="if(this.value=='')this.value='BOLICHES, CIUDAD, BARRIO, DEPARTAMENTO'"></div>
			...
			<button type="submit" class="em-search-submit loading">
				...
				<!--[if IE 7]><span><![endif]-->
				<img src="<?php echo EM_DIR_URI; ?>includes/images/search_location.png" />
				<!--[if IE 7]></span><![endif]-->
			</button>
			<?php endif; ?>
		</div>
