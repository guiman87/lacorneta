...
<!-- Row for main content area -->
	...
	<section class="entry-content clearfix" itemprop="articleBody">
					...
					<table cellpadding="5" cellspacing="0" width="100%" id="fiestatable" class="row-border restotablas hover">
    <thead>
        <tr>
            <th>FECHA</th>
	    <th>               </th>
    ...
    <tbody><?php echo do_shortcode('[events_list  scope="future"  category="fiestas" limit="50"]{is_past} {/is_past}{is_current}<tr  itemscope itemtype="http://schema.org/Event">
    <td ><span class="hoytime"><meta itemprop="startDate" content="#_{Y-m-d\TH:i:sO}">#D #d<span style="font-size: 11px;" >AHORA!</span> </span></td>
