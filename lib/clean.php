...
function reverie_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script('jquery-datatables', get_template_directory_uri() . '/js/DataTables-1.10.0/media/js/jquery.dataTables.js','', true);
    wp_register_script('jquery-datatables-searchfilter', get_template_directory_uri() . '/js/accent-neutralise.js','', true);
    wp_register_script( 'orbit-js', get_template_directory_uri() . '/bower_components/foundation/js/foundation/foundation.orbit.js', array( 'jquery' ), '', true );
    
    wp_enqueue_script('fancybox', get_template_directory_uri().'/js/fancybox/source/jquery.fancybox.pack.js', array( 'jquery' ), false, true );
    wp_register_script( 'scripts_theme', get_template_directory_uri() . '/js/scripts_theme.js', array( 'jquery' ), '', true );
    ...
    */
    ...
    wp_enqueue_script('jquery-datatables-searchfilter');
    wp_enqueue_script('jquery-customscroll');
    wp_enqueue_script('fancybox');
    wp_enqueue_script('scripts_theme');
