...
<!-- Row for main content area -->
	...
	<section class="entry-content clearfix" itemprop="articleBody">
					...
					<table cellpadding="5" cellspacing="0" width="100%" id="fiestatable" class="row-border mundial2014 restotablas hover">
    <thead>
        <tr>
            <th>FECHA</th>
	    <th>               </th>
    ...
    <tbody><?php echo do_shortcode('[events_list  scope="future"  tag="Mundial Brasil 2014" limit="50"]{is_past} {/is_past}{is_current}<tr  itemscope itemtype="http://schema.org/Event">
    <td ><span class="hoytime"><meta itemprop="startDate" content="#_{Y-m-d\TH:i:sO}">#D #d</span><span style="font-size: 11px; display: block;" >AHORA!</span></td>
...
<td class=""><span>#_#_EVENTCATEGORIES</span></td>
    ...
    <td ><span class="hoytime"><meta itemprop="startDate" content="#_{Y-m-d\TH:i:sO}">#D #d</span></td>
    <td ><span class=""><a href="#_EVENTURL">#_EVENTIMAGE{100,60}</a></span></td>
					<td class=""><a itemprop="url"  href="#_EVENTURL"><span itemprop="name">#_EVENTNAME</span></a></td>
<td itemprop="addressRegion"  class="regiontabla">#_LOCATIONREGION</td>
					<td itemprop="location" itemscope itemtype="http://schema.org/Place" itemprop="name" class=""><a class="link_location" itemprop="url"  href="#_LOCATIONURL"><span itemprop="name">#_LOCATIONNAME</span><a></td>
